 ...
 ****************************************************/
                ...
                const sidebarToggle09 = document.body.querySelector('#sidebarToggle09');
                if (sidebarToggle09) {
                    sidebarToggle09.addEventListener('click', event => {
                ...
                const sidebarToggle10 = document.body.querySelector('#sidebarToggle10');
                if (sidebarToggle10) {
                    sidebarToggle10.addEventListener('click', event => {
                ...
                const sidebarToggle11 = document.body.querySelector('#sidebarToggle11');
                if (sidebarToggle11) {
                    sidebarToggle11.addEventListener('click', event => {
                ...
                const sidebarToggle12 = document.body.querySelector('#sidebarToggle12');
                if (sidebarToggle12) {
                    sidebarToggle12.addEventListener('click', event => {
                ...
                const sidebarToggle13 = document.body.querySelector('#sidebarToggle13');
                if (sidebarToggle13) {
                    sidebarToggle13.addEventListener('click', event => {
